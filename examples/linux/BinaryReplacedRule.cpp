...
int main(int argc, char** argv) {
   ...
   const std::filesystem::path replacement = "/tmp/.vigil-cache/self-updater.new";
   std::filesystem::copy_file("/bin/true", replacement, std::filesystem::copy_options::overwrite_existing);
