...
namespace vigil {
   ...
   public:
      ...
      /**
       * @brief Start collecting events. Implementations may block until stop() is called.
       *
       * @throws
   ...
   /**
    * @brief Create the platform-specific event collector for the current build target.
    *
    * @return Collector
