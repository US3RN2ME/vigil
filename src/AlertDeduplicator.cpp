...
AlertDeduplicator::AlertDeduplicator(const std::chrono::milliseconds cooldown,
                                     const std::size_t maxEntries)
    : cooldown_{cooldown}, maxEntries_{std::max(maxEntries, std::size_t{1})} {}

bool AlertDeduplicator::shouldEmit(const Alert &alert,
