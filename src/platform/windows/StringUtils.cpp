...
namespace vigil::platform {
   std::string StringUtils::wideToUtf8(const wchar_t* wide, int size) {
      ...
      const auto required = WideCharToMultiByte(CP_UTF8, 0, wide, size, nullptr, 0, nullptr, nullptr);
      ...
      const auto written = WideCharToMultiByte(CP_UTF8, 0, wide, size, utf8.data(), required, nullptr, nullptr);
