...
#ifndef VIGIL_PLATFORM_LINUX_RULES_KERNELMODULELOADRULE_HPP
#define VIGIL_PLATFORM_LINUX_RULES_KERNELMODULELOADRULE_HPP
...
#endif // VIGIL_PLATFORM_LINUX_RULES_KERNELMODULELOADRULE_HPP
